 ...
 * marked along it.
 *
 * This is the part that makes doing it together worth recording: reactions are
 * pinned to a position in the media rather than to a moment in time, so a year
 * later the same song or film replays what you both said the first time.
 */
        ...
        reactions.map((r) => (
          <span
            ...
            style={{
              ...
              background: r.author_id === meId ? "var(--amber)" : "var(--rose)",
            }}
          />
        ))}
